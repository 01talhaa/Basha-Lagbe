...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      {/* Hero Section */}
      <section className="relative bg-linear-to-br from-primary via-primary-dark to-accent-blue text-white py-20">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-1 space-y-8">
            <div>
              <h2 className="text-3xl font-bold mb-8 text-neutral-900">Contact Information</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+8801401658685" className="text-neutral-600 hover:text-primary transition-colors">
                      +880 1401-658685
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@bashalagbe.com" className="text-neutral-600 hover:text-primary transition-colors">
                      info@bashalagbe.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/8801401658685" target="_blank" rel="noopener noreferrer" className="text-neutral-600 hover:text-green-600 transition-colors">
                      +880 1401-658685
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-neutral-200">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-neutral-600">Saturday - Thursday</span>
          ...
          <div className="md:col-span-2">
            <div className="bg-white p-8 md:p-10 rounded-2xl shadow-lg border border-neutral-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-neutral-900"
                    >
                ...
                <button
                  ...
                  className="w-full bg-primary hover:bg-primary-dark text-white px-8 py-4 rounded-xl font-semibold shadow-lg transition-all hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
